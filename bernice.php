                ...
                <div class="in_row wpb_row in_row-fluid single-member-page">
                  <div class="wpb_column in_column_container in_col-sm-5">
                    <div class="in_column-inner">
                      ...
                      <img src="img/team/bernice.jpg" width="400" alt="Bernice KAMWENUBUSA">

                      <div class="team-infobox" style="font-family: 'Times New Roman'">
                    <div class="team_title">
                    <h3 style="padding-top:15px">Bernice Kamwenubusa</h3>
                    </div>
                    <div class="team_info">
                    ...
                    <div>
                    <h5>Profile:</h5>
                    &nbsp;&nbsp;<a href="#" class="team-link">Bernice Kamwenubusa </a>
                    </div>
                    <div>
                    <h5>E-Mail:</h5>
                    &nbsp;<a href="mailto:bkamwenubusa@r-partnerslawfirm.com" class="team-link">
                        bkamwenubusa@r-partnerslawfirm.com
                      </a>
                    </div>
                            ...
                            <div class="wpb_wrapper">
                              ...
                              <div class="wpb_text_column wpb_content_element">
                                ...
                                <p style="font-family: 'Times New Roman';text-align:justify">
                                    Meet Bernice, a Junior Associate who obtained her Bachelor of Law Degree (LLB) from the
                                    University of Rwanda in 2023 and is currently pursuing a Diploma in Legal Practice from the
                                    Institute of Legal Practice and Development.
                                    <br>
                                    Bernice is particularly drawn to the various aspects of Corporate and Commercial Law. From
                                    contract drafting to regulatory compliance, her dedication to always excel and continuously
                                    expand her knowledge enables her to provide quality return.
                                    <br>
                                    Boasting an excellent command of both French and English, her bilingual proficiency allows
                                    her to effectively assess legal issues brought by clients from diverse backgrounds, adding a
                                    valuable international dimension to her legal capabilities.
                                    <br>
