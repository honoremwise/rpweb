  ...
  >
	<div class="gt3-page-title__inner">
	  <div class="container">
		...
		<span class="current" style="padding-left: 35px;font-size:20px">
                Banking & Finance
              </span>
			</div>
		  </div>
			...
			<div class='container'>
				<div class='gt3-page-title__content'>
					...
					<div class='page_sub_title'>
						<div>Reach Out to Us Anytime and We Will Happily Assist You</div>
					</div>
				</div>
			</div>
		</div>
...
experience in regulatory compliance, loan agreements and financing, securities and capital
markets regulations, mergers and acquisitions, fiscal requirements and international financial
standards.
        <br> <br>
        We routinely provide legal advice to a wide array of entities including financial institutions,
corporations, investors, and other stakeholders in the industry.
<br><br>
Our Team specializes in providing expert guidance to financial institutions, covering areas
such as financial transactions, lending, investments, regulatory compliance, and the
implementation of risk management strategies.

         </p>
</div>

<?php include('otherPracticeAreas.php');?>
