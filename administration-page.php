                              ...
                              <div class="in_col-sm-12 module_team">
                                <div class="shortcode_team">
                                  <div class="items3">
                                    <ul class="item_list">
                                      <li
                                        class="item-team-member gotoMember" onclick="window.location='kassandra.php'"
                                      >
                                        <div class="item_wrapper">
                                          <div class="item">
                                            <div class="team_img featured_img">
                                              <a href="kassandra.php">
                                                <img
                                                  src="img/team/kassandra.jpg"
                                                  alt=""
                                                />
                                              </a>
                                            </div>
                                            ...
                                            <div class="team-infobox">
                                              <div class="team_title">
                                                <h4><a href="kassandra.php"> Kerssy Kassandra Ishimwe </a></h4>
                                              ...
                                              <div class="team_info">
                                                <div class="team_icons_wrapper">
                                                  <div class="team-links">
                                                    ...
                                                    <a
                                                      href="mailto:kishimwe@r-partnerslawfirm.com"
                                                      class="team-link"
                                                      title="kishimwe@r-partnerslawfirm.com"
                                                      >kishimwe@r-partnerslawfirm.com</a
                                                    >
                                                    <br>
                                                    <b><a href="kassandra.php">Read More>></a></b>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
