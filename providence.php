                ...
                <div class="in_row wpb_row in_row-fluid single-member-page">
                  <div class="wpb_column in_column_container in_col-sm-5">
                    <div class="in_column-inner">
                      <div class="team_img featured_img" style="margin-left:40px">
                      <img src="img/team/providence.jpg" width="400" alt="Providence NYINAWAMWEZI">

                      <div class="team-infobox">
                    <div class="team_title">
                    <h3 style="padding-top:15px">Providence Nyinawamwezi</h3>
                    </div>
                    <div class="team_info">
                    ...
                    <div>
                    <h5>Profile:</h5>
                    &nbsp;&nbsp;<a href="#" class="team-link">Providence Nyinawamwezi </a>
                    </div>
                    <div>
                    <h5>E-Mail:</h5>
                    &nbsp;<a href="mailto:pnyinawamwezi@r-partners.com" class="team-link">
                        pnyinawamwezi@r-partners.com
                      </a>
                    </div>
                            ...
                            <div class="wpb_wrapper">
                              ...
                              <div class="wpb_text_column wpb_content_element">
                                ...
                                <p style="font-family: 'Times New Roman';text-align:justify">
                                    Member of the Rwanda Bar Association, East Africa Law Society.
                                    <br>
                                    Providence is Advocate and collaborator at R&amp; PARTNERS LAW FIRM.
                                    <br>
                                    She holds an MBA diploma from Ecole Nationale d’Assurance de Paris/France and a Diploma in insurance practice.
                                    <br>
                                    She holds a Bachelor of laws (LLB) from the National University of Rwanda (2000), postgraduate Diploma in Legal Practice of the institute
                                   of Legal Practice &amp; development (ILPD) and a Certificate in Mediation Skills. 
                                   <br>
                                    Providence has an excellent expertise in Insurance Matters, transactions, claims, Mediation for more than 20 years.
                                   <br>
                                    Before joining R&amp; PARTNERS LAW FIRM, Providence has occupied different posts in different companies, Managing Director for more
                                   than 10 years, Marketing Manager, Claims Manager, Consultant in Ministry of Justice, Program Assistant at UNDP, etc.
                                   <br>
                                    She has an excellent command of French, Kinyarwanda and English.
                                  <br> 
