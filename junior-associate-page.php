                              ...
                              <div class="in_col-sm-12 module_team">
                                <div class="shortcode_team">
                                  <div class="items3">
                                    <ul class="item_list">
                                      <li
                                        class="item-team-member gotoMember" onclick="window.location='bernice.php'"
                                      >
                                        <div class="item_wrapper">
                                          <div class="item">
                                            <div class="team_img featured_img">
                                              <a href="bernice.php">
                                                <img
                                                  src="img/team/bernice.jpg"
                                                  alt="Bernice KAMWENUBUSA"
                                                />
                                              </a>
                                            </div>
                                            ...
                                            <div class="team-infobox">
                                              <div class="team_title">
                                                <h4><a href="bernice.php"> Bernice Kamwenubusa </a></h4>
                                                <span class="team-positions">
                                                  - <span>Junior</span>
                                                  <span>Associate</span></span
                                                >
                                              </div>
                                              <div class="team_info">
                                                <div class="team_icons_wrapper">
                                                  <div class="team-links">
                                                    ...
                                                    <a
                                                      href="mailto:bkamwenubusa@r-partnerslawfirm.com"
                                                      class="team-link"
                                                      title="bkamwenubusa@r-partnerslawfirm.com"
                                                      >bkamwenubusa@r-partnerslawfirm.com</a
                                                    >
                                                    <br>
                                                    <b><a href="bernice.php">Read More>></a></b>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
