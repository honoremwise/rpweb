                              ...
                              <div class="in_col-sm-12 module_team">
                                <div class="shortcode_team">
                                  <div class="items3">
                                    <ul class="item_list">
                                      <li
                                        class="item-team-member gotoMember" onclick="window.location='providence.php'"
                                      >
                                        <div class="item_wrapper">
                                          <div class="item">
                                            <div class="team_img featured_img">
                                              <a href="providence.php">
                                                <img
                                                  src="img/team/providence.jpg"
                                                  alt=""
                                                />
                                              </a>
                                            </div>
                                            ...
                                            <div class="team-infobox">
                                              <div class="team_title">
                                                <h4><a href="providence.php">Providence Nyinawamwezi </a></h4>
                                              ...
                                              <div class="team_info">
                                                <div class="team_icons_wrapper">
                                                  <div class="team-links">
                                                    ...
                                                    <a
                                                      href="mailto:pnyinawamwezi@r-partners.com"
                                                      class="team-link"
                                                      title="pnyinawamwezi@r-partners.com"
                                                      >pnyinawamwezi@r-partners.com</a
                                                    >
                                                  </div>
                                                </div>
                                              </div>
